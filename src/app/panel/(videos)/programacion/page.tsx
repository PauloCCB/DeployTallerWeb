      ...
      <div className="flex flex-1 text-black">
        ...
        <div className="flex-1 bg-[#F3F4F6]">
          <div className="aspect-video bg-black relative flex items-center justify-center">
            {loading ? (
              <p className="text-center text-black">Cargando contenido...</p>
            ) : !video ? (
        ...
        <div className="w-[400px] p-8 border-l">
          ...
          <p className="text-gray-600 mb-8">
            Aprende los conceptos fundamentales de la programación. Este curso
            te ayudará a desarrollar una base sólida en algoritmos, estructuras
