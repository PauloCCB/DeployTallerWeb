    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex flex-1 text-black">
        ...
        <div className="w-[400px] p-8 border-l">
          <h1 className="text-2xl font-semibold mb-2">Introducción a la física</h1>
          <p className="text-sm text-gray-600 mb-4">Por Juan Perez</p>
          ...
          Aprende los conceptos fundamentales de la física. Este curso te ayudará a desarrollar una base sólida  
          en mecánica, termodinámica y electromagnetismo.
          </p>
