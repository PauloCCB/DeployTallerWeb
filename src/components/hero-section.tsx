    ...
    <section className="relative min-h-screen pt-32 pb-16 overflow-hidden bg-black">
      ...
      >
        <div className="text-center mb-16">
          ...
          Creemos que el conocimiento debe ser 
          accesible para todos, sin importar la distancia. Nuestra plataforma conecta a estudiantes y profesionales con oportunidades de aprendizaje de calidad, permitiendo que la educación llegue a cada rincón del mundo.
          </p>
